...
st.markdown(
    ...
    "compares metrics, and lets you **upload a test CSV** and **download** a "
    "**single full test CSV (features only, 569 rows)** plus the **best model (.pkl)**."
)
...
# ---------- Sidebar download: single full features-only CSV ----------
# Build the full dataset CSV (features only, 569 rows) in memory to avoid file clutter
